...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        if ($repo->save($rol)) {
            ...
            $error = 'Error al guardar el rol. Verifique que el nombre no esté duplicado.';
        }
    } catch (Exception $e) {
        $error = $e->getMessage();
    }
        ...
        <div class="col-12">
            <div class="roles-header" style="background: linear-gradient(135deg, #7c3aed 0%, #a855f7 100%); border-radius: 20px; padding: 25px; color: white; box-shadow: 0 10px 40px rgba(124, 58, 237, 0.3);">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h2 class="mb-0 fw-bold"><i class="bi bi-shield-plus me-3"></i>Nuevo Rol</h2>
                        <p class="mb-0 opacity-75">Crea un nuevo rol con permisos específicos</p>
                    </div>
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="nombre" class="form-control border-0 shadow-none" style="border-radius: 0 12px 12px 0; background: #f8f9fa;" placeholder="Ej: Administrador, Vendedor, Almacenero" required>
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <select class="form-select border-0 shadow-none" style="border-radius: 0 12px 12px 0; background: #f8f9fa;" disabled>
                                    <option value="1" selected>Activo</option>
                                </select>
                            </div>
                            <small class="text-muted">Los nuevos roles se crean como activos</small>
                        </div>
                        <div class="col-12">
                            ...
                            <div class="input-group">
                                ...
                                <textarea name="descripcion" class="form-control border-0 shadow-none" style="border-radius: 0 12px 12px 0; background: #f8f9fa;" rows="4" placeholder="Describe las funciones y responsabilidades de este rol..."></textarea>
                            </div>
                        </div>
                    </div>
                ...
                <div class="step-content d-none" id="step-2">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4 col-lg-3">
                            <div class="permiso-card card border-0 shadow-sm h-100" style="border-radius: 16px; cursor: pointer; transition: all 0.2s;" onclick="togglePermiso('<?php echo $key; ?>')">
                                <div class="card-body p-3 text-center">
                                    <div class="form-check d-flex justify-content-center mb-2">
                                        <input class="form-check-input permiso-check" type="checkbox" name="permisos[]" value="<?php echo $key; ?>" id="perm_<?php echo $key; ?>" style="width: 20px; height: 20px;">
                                    </div>
                    ...
                    <div class="mt-4 p-3 border rounded-3" style="background: #faf5ff;">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <span class="badge bg-primary rounded-pill fs-6" id="contadorPermisos">0</span>
                        </div>
                    </div>
                </div>
...
renderLayout('Nuevo Rol', $content);
