...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        $usuario->estado = intval($_POST['estado'] ?? 1);
        ...
        if ($usuarioRepo->save($usuario)) {
            ...
            $usuario = $usuarioRepo->findById($id); // Recargar
        } else {
            ...
            <div class="usuarios-header" style="background: linear-gradient(135deg, #1e3a8a 0%, #3b82f6 100%); border-radius: 20px; padding: 25px; color: white; box-shadow: 0 10px 40px rgba(30, 58, 138, 0.3);">
                <div class="d-flex justify-content-between align-items-center">
                    <div class="d-flex align-items-center gap-4">
                        ...
                        <div>
                            <h2 class="mb-0 fw-bold"><?php echo htmlspecialchars($usuario->getNombreCompleto()); ?></h2>
                            <p class="mb-0 opacity-75">
                                <i class="bi bi-person-badge me-1"></i><?php echo htmlspecialchars($usuario->username); ?> | 
                                <i class="bi bi-shield me-1"></i><?php echo htmlspecialchars($usuario->rol_nombre ?? 'Sin rol'); ?>
                            </p>
                        </div>
                    </div>
        ...
        <div class="card-header border-0 py-3" style="background: linear-gradient(135deg, #eff6ff 0%, #dbeafe 100%);">
            <div class="stepper-wrapper d-flex justify-content-center">
                <div class="stepper-item active" data-step="1">
                    <div class="step-counter rounded-circle d-flex align-items-center justify-content-center" style="width: 40px; height: 40px; background: linear-gradient(135deg, #1e3a8a, #3b82f6); color: white;">
                        <i class="bi bi-person"></i>
                    </div>
                    <div class="step-name small mt-2 fw-bold text-primary">Datos Personales</div>
                </div>
        ...
        <div class="card-body p-4">
            <form method="POST" id="formUsuario" novalidate>
                ...
                <div class="step-content" id="step-1">
                    <h5 class="mb-4 text-primary fw-bold"><i class="bi bi-person me-2"></i>Información Personal</h5>
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="nombre" class="form-control border-0 shadow-none" style="border-radius: 0 12px 12px 0; background: #f8f9fa;" 
                                       value="<?php echo htmlspecialchars($usuario->nombre); ?>" required placeholder="Nombres del usuario">
                            </div>
                        </div>
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <span class="input-group-text bg-white border-0" style="border-radius: 12px 0 0 12px;"><i class="bi bi-person text-primary"></i></span>
                                <input type="text" name="apellido" class="form-control border-0 shadow-none" style="border-radius: 0 12px 12px 0; background: #f8f9fa;" 
                                       value="<?php echo htmlspecialchars($usuario->apellido); ?>" required placeholder="Apellidos del usuario">
                            </div>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <span class="input-group-text bg-white border-0" style="border-radius: 12px 0 0 12px;"><i class="bi bi-toggle-on text-primary"></i></span>
                    ...
                    <!-- Info adicional -->
                    <div class="mt-4 p-3 border rounded-3" style="background: linear-gradient(135deg, #eff6ff, #dbeafe);">
                        <div class="row">
                            <div class="col-md-4">
                                <small class="text-muted"><i class="bi bi-calendar me-1"></i>Creado: <strong><?php echo $usuario->fecha_creacion ? date('d/m/Y H:i', strtotime($usuario->fecha_creacion)) : 'N/A'; ?></strong></small>
                            </div>
                            <div class="col-md-4">
                                <small class="text-muted"><i class="bi bi-clock-history me-1"></i>Actualizado: <strong><?php echo $usuario->fecha_actualizacion ? date('d/m/Y H:i', strtotime($usuario->fecha_actualizacion)) : 'N/A'; ?></strong></small>
                            </div>
                            <div class="col-md-4">
                                <small class="text-muted"><i class="bi bi-box-arrow-in-right me-1"></i>Último acceso: <strong><?php echo $usuario->ultimo_acceso ? date('d/m/Y H:i', strtotime($usuario->ultimo_acceso)) : 'Nunca'; ?></strong></small>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="username" class="form-control border-0 shadow-none" style="border-radius: 0 12px 12px 0; background: #f8f9fa;" 
                                       value="<?php echo htmlspecialchars($usuario->username); ?>" required placeholder="username">
                            </div>
                            <small class="text-muted">El usuario usa este nombre para iniciar sesión</small>
                        </div>
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="email" name="email" class="form-control border-0 shadow-none" style="border-radius: 0 12px 12px 0; background: #f8f9fa;" 
                                       value="<?php echo htmlspecialchars($usuario->email); ?>" required placeholder="correo@ejemplo.com">
                            </div>
                        </div>
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="password" name="password" class="form-control border-0 shadow-none" style="border-radius: 0 12px 12px 0; background: #f8f9fa;" placeholder="Dejar en blanco para mantener actual">
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="password" name="password_confirm" class="form-control border-0 shadow-none" style="border-radius: 0 12px 12px 0; background: #f8f9fa;" placeholder="Repita la nueva contraseña">
                            </div>
                        </div>
                    </div>
                    
                    <!-- Alerta de seguridad -->
                    <div class="mt-4 alert alert-warning border-0 rounded-3" style="background: linear-gradient(135deg, #fefce8, #fef9c3);">
                        <div class="d-flex align-items-center">
                            <i class="bi bi-exclamation-triangle-fill text-warning fs-4 me-3"></i>
                            <div>
                                <h6 class="fw-bold mb-1 text-warning">Importante</h6>
                                <p class="mb-0 small text-dark">Si cambia la contraseña, el usuario deberá usar la nueva contraseña en su próximo inicio de sesión.</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="telefono" class="form-control border-0 shadow-none" style="border-radius: 0 12px 12px 0; background: #f8f9fa;" 
                                       value="<?php echo htmlspecialchars($usuario->telefono ?? ''); ?>" placeholder="Número de teléfono">
                            </div>
                        </div>
                        <div class="col-12">
                            ...
                            <div class="input-group">
                                ...
                                <textarea name="direccion" class="form-control border-0 shadow-none" style="border-radius: 0 12px 12px 0; background: #f8f9fa;" rows="3" placeholder="Dirección completa"><?php echo htmlspecialchars($usuario->direccion ?? ''); ?></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="d-flex justify-content-between mt-4 pt-4 border-top">
                    ...
                    <div></div>
                    <button type="button" class="btn btn-primary rounded-pill px-4 text-white" id="btnNext" onclick="changeStep(1)" style="background: linear-gradient(135deg, #1e3a8a, #3b82f6); border: none;">
    ...
    function updateStepper(step) {
        ...
        items.forEach((item, index) => {
            ...
            if (stepNum < step) {
                ...
                const icons = ['bi-person', 'bi-shield-lock', 'bi-telephone'];
...
renderLayout('Editar Usuario: ' . $usuario->getNombreCompleto(), $content);
